#!/bin/bash
# =============================================================================
# trigger-devsecops-pipeline.sh — Trigger the DevSecOps Pipeline on Jenkins
# =============================================================================
# Usage:
#   ./trigger-devsecops-pipeline.sh [OPTIONS]
#
# Examples:
#   # Auto-detect language, run all scans
...
#
#   # Run only unit tests (skip security)
#   ./trigger-devsecops-pipeline.sh --language python --skip-security
#
#   # Full scan with K8s deploy
#   ./trigger-devsecops-pipeline.sh --image-name catool --deploy
# =============================================================================
